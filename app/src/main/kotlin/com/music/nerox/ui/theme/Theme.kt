...
package com.music.nerox.ui.theme
...
val DefaultThemeColor = Color(0xFF7B68EE) // Nerox Music v4 — medium slate blue accent
...
fun vivimusicTheme(
    ...
    val selectedFontValue by rememberPreference(SelectedFontKey, AppFont.PLUS_JAKARTA_SANS.value)
