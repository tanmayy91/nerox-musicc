...
import com.music.nerox.constants.LastFMSessionKey
import com.music.nerox.constants.LastFMUseNowPlaying
import com.music.nerox.constants.LastFMUseSendLikes
import com.music.nerox.constants.LastFMUsernameKey
                                    ...
                                    .onFailure { exception ->
                                        coroutineScope.launch(Dispatchers.Main) {
                                            ...
                                            loginError = when (exception) {
                                                is com.music.lastfm.LastFM.LastFmException -> {
                                                    when (exception.code) {
