...
package com.music.nerox.vivimusic.updater
...
import com.music.nerox.vivimusic.updater.downloadmanager.UpdateDownloadWorker
import com.music.nerox.vivimusic.updater.downloadmanager.DownloadNotificationManager
...
import com.music.nerox.ui.component.ChangelogItem
import com.music.nerox.ui.component.leadingItemShape
import com.music.nerox.ui.component.middleItemShape
import com.music.nerox.ui.component.endItemShape
import com.music.nerox.ui.component.detachedItemShape
import com.music.nerox.ui.component.AnimatedActionButton
import com.music.nerox.ui.component.ExpressiveIconButton
import com.music.nerox.ui.component.ErrorSnackbar
                                ...
                                AnimatedActionButton(
                                    ...
                                    onClick = {
                                        if (isDownloadComplete) {
                                            ...
                                            val urlToDownload = currentStatus.apkUrl ?: "https://github.com/tanmayy91/vivi-music/releases/download/${currentStatus.version}/vivi.apk"
                                ...
                                Column(
                                    ...
                                    currentStatus.changelog.forEach { section ->
                                        ...
                                        section.items.forEachIndexed { index, item ->
                                            val shape = when {
                                                section.items.size == 1 -> com.music.nerox.ui.component.detachedItemShape()
                                                index == 0 -> com.music.nerox.ui.component.leadingItemShape()
                                                index == section.items.size - 1 -> com.music.nerox.ui.component.endItemShape()
                                                else -> com.music.nerox.ui.component.middleItemShape()
                                            }
                                            com.music.nerox.ui.component.ChangelogItem(
                                                text = item,
                                                shape = shape,
...
suspend fun checkForUpdate(
    ...
    withContext(Dispatchers.IO) {
        try {
            val url = URL("https://api.github.com/repos/tanmayy91/vivi-music/releases")
            ...
            if (betaEnabled) {
                try {
                    val nightlyUrl = URL("https://api.github.com/repos/tanmayy91/vivi-music/actions/workflows/nightly.yml/runs?status=success&per_page=1")
            ...
            if (isNightlyUpdate && nightlyRunObject != null) {
                ...
                val apkDownloadUrl = "https://nightly.link/tanmayy91/vivi-music/workflows/nightly.yml/main/vivi-music-gms-nightly.zip"
            ...
            if (targetRelease != null) {
                ...
                if (shouldShow) {
                    ...
                    try {
                        val changelogUrl =
                            URL("https://github.com/tanmayy91/vivi-music/releases/download/$tagWithPrefix/changelog.json")
