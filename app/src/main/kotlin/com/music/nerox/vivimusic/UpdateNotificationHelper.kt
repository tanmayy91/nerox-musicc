package com.music.nerox.vivimusic
...
object UpdateNotificationHelper {
    ...
    fun showUpdateNotification(context: Context, versionName: String) {
        ...
        val apkUrl = if (versionName.contains("nightly", ignoreCase = true)) {
            "https://nightly.link/tanmayy91/vivi-music/workflows/nightly.yml/main/vivi-music-gms-nightly.zip"
        } else {
            "https://github.com/tanmayy91/vivi-music/releases/download/$versionName/vivi.apk"
        }
