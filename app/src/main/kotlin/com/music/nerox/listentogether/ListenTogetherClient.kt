...
import com.music.nerox.constants.ListenTogetherAutoApprovalKey
import com.music.nerox.constants.ListenTogetherIsHostKey
import com.music.nerox.constants.ListenTogetherRoomCodeKey
import com.music.nerox.constants.ListenTogetherServerUrlKey
import com.music.nerox.constants.ListenTogetherSessionTimestampKey
import com.music.nerox.constants.ListenTogetherSessionTokenKey
import com.music.nerox.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.music.nerox.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.music.nerox.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.music.nerox.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.music.nerox.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.music.nerox.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.music.nerox.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
